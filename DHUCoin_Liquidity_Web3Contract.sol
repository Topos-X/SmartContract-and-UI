...
contract DHUCoin is StandardToken{
    ...
    function tokenAllocation(address investor, uint256 amountTokens) private{
        ...
        uint256 theoJawadAllocation = safeMul(amountTokens, 1764705882352941) / 10000000000000000;
    ...
    function verifyInvestor(address _investor) public onlyControllingWallets{
    ...
    function liquidate() external{
        ...
        PriceDHU storage price = prices[requestTime];
